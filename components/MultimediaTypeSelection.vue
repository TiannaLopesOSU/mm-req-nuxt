<template>
  <div>
    ...
    <div class="card shadow-sm mt-4">
      <div class="card-body">
        ...
        <p class="card-text text-muted small">
          Please choose the type of media you’d like to request below. If you
          have multiple media pieces needed, please submit individual requests.
          For multimedia deadlines, please refer to our
        ...
        <div ref="componentSection" v-if="selectedTypeComponent" class="mt-4">
    ...
    >
      <button class="btn btn-outline-secondary" @click="selectedType = null">
        Cancel
      </button>
...
const componentSection = ref(null);

const handleClick = async (type) => {
  selectedType.value = type;
  await nextTick();
  if (componentSection.value) {
    componentSection.value.scrollIntoView({ behavior: "smooth" });
  }
};
